<template>
    <section>
        <h1 class="text-5xl font-bold mt-20">Helo, I'm Michael</h1>
        <p class="text-base text-gray-900 p-2 italic">
            Laravel Developer Advocate at Sproutly
        </p>
    </section>
    ...
    <section class="flex flex-col md:flex-row">
        ...
        <img src="~/assets/images/work5.jpg" class="w-1/2 md:max-w-sm p-8 mx-auto" />
    </section>
